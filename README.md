...
```bash
git clone https://github.com/yourusername/gogo-studio.git
cd gogo-studio
```
...
1. 访问 [Issues 页面](https://github.com/yourusername/gogo-studio/issues)
2. 搜索是否已有相似问题
3. 创建新 Issue，提供详细描述
...
- **问题反馈**: [GitHub Issues](https://github.com/yourusername/gogo-studio/issues)
